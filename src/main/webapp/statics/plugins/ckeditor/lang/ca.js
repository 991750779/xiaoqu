...
CKEDITOR.lang['ca'] = {
    ...
    "bidi": {"ltr": "Direcció del text d'esquerra a dreta", "rtl": "Direcció del text de dreta a esquerra"},
    ...
    "font": {
        "fontSize": {"label": "Mida", "voiceLabel": "Mida de la lletra", "panelTitle": "Mida de la lletra"},
    ...
    "forms": {
        ...
        "textarea": {"title": "Propietats de l'àrea de text", "cols": "Columnes", "rows": "Files"},
        "textfield": {
    ...
    "smiley": {"options": "Opcions d'emoticones", "title": "Insereix una icona", "toolbar": "Icona"},
    "justify": {
        "block": "Justificat",
        "center": "Centrat",
    ...
    "pastetext": {"button": "Enganxa com a text no formatat", "title": "Enganxa com a text no formatat"},
    "pastefromword": {
